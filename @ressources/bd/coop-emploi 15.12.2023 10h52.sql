...
--
-- Host: localhost:3306
-- Generation Time: Dec 15, 2023 at 09:52 AM
...
(13, 'centreal', 'Thomas', '0777995137', 'toto41700@hotmail.fr', 'SLAM', '2023-12-15 09:47:21', '2023-12-15 09:47:21');
...
CREATE TABLE `p4t1_porteur_de_projet` (
  ...
  `pdp_ad1` varchar(38) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '1- Service,N°de bureau ou d''étage',
  `pdp_ad2` varchar(38) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '2- Résidence, Immeuble, Batiment, ZI',
  `pdp_ad3` varchar(38) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '3- Numéro voie, type, nom de la voie',
  `pdp_ad4` varchar(38) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '4- Mention de distribution (BP,...), lieu-dit',
  ...
  `pdp_pri` tinyint(1) DEFAULT '0' COMMENT 'Presence reugnion d''info collective',
  `pdp_een` tinyint(1) DEFAULT '0' COMMENT 'Est entrepreneur o/n',
  `pdp_sor` tinyint(1) DEFAULT '0' COMMENT 'Non accepté ou pdp sorti',
  `pdp_reu` int NOT NULL COMMENT 'ID de la reuginon d''iformation collective',
...
CREATE TABLE `p4t1_utilisateur` (
  ...
  `uti_log` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Login de connexion',
...
--
-- Dumping data for table `p4t1_utilisateur`
--

INSERT INTO `p4t1_utilisateur` (`uti_ide`, `uti_log`, `uti_mdp`, `uti_ide_acc`, `uti_ide_ent`, `uti_dcr`, `uti_dmo`) VALUES
(1, 'TC20231215-1047', 'coopemploi', 13, NULL, '2023-12-15 09:47:21', '2023-12-15 09:47:21');
...
--
ALTER TABLE `p4t1_accompagnateurs`
  MODIFY `acc_ide` int NOT NULL AUTO_INCREMENT COMMENT 'Identifiant de l''accompagnateur ', AUTO_INCREMENT=14;
...
--
ALTER TABLE `p4t1_reunion`
  MODIFY `reu_ide` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `p4t1_utilisateur`
--
ALTER TABLE `p4t1_utilisateur`
  MODIFY `uti_ide` int NOT NULL AUTO_INCREMENT COMMENT 'Identifiant', AUTO_INCREMENT=2;
