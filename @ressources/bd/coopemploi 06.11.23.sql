...
--
-- Hôte : localhost:3306
-- Généré le : lun. 06 nov. 2023 à 13:15
...
(9, 'centreal', 'Thoma', '0504520727', 'toto41700@hotmail.fr', 'SLAM', '2023-09-14 15:16:34', '2023-09-14 15:16:34'),
(30, 'masque', 'samuel', '0602020202', '640poto@gmail.com', 'SLAM', '2023-11-06 12:59:20', '2023-11-06 12:59:20');
...
CREATE TABLE `p4t1_utilisateur` (
  ...
  `uti_log` varchar(13) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Login de connexion',
...
(1, NULL, 'coopemploi', NULL, NULL, '2023-11-03 22:11:02', '2023-11-03 22:11:02'),
(6, '', 'coopemploi', 30, NULL, '2023-11-06 12:59:20', '2023-11-06 12:59:20');
...
--
ALTER TABLE `p4t1_accompagnateurs`
  MODIFY `acc_ide` int NOT NULL AUTO_INCREMENT COMMENT 'Identifiant de l''accompagnateur ', AUTO_INCREMENT=31;
...
--
ALTER TABLE `p4t1_utilisateur`
  MODIFY `uti_ide` int NOT NULL AUTO_INCREMENT COMMENT 'Identifiant', AUTO_INCREMENT=7;
