...
{
    public function rechercheReunion(): object
    {

        $sql = 'SELECT reu_ide, reu_dat, reu_heu, reu_dur, reu_pre, reu_cap, lie_nom, lie_cpo, lie_ville'
            . ' FROM p4t1_reunion AS r , p4t1_lieux AS l'
