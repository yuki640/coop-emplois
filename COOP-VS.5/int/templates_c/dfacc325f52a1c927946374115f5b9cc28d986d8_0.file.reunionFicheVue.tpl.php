<?php
/* Smarty version 4.3.2, created on 2023-12-14 14:08:29
  from 'C:\laragon\www\coop-emplois\COOP-VS.5\int\mod_reunion\vue\reunionFicheVue.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.2',
  'unifunc' => 'content_657afe4de24d74_63152445',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'dfacc325f52a1c927946374115f5b9cc28d986d8' => 
    array (
      0 => 'C:\\laragon\\www\\coop-emplois\\COOP-VS.5\\int\\mod_reunion\\vue\\reunionFicheVue.tpl',
      1 => 1702551450,
      2 => 'file',
    ),
  ),
...
function content_657afe4de24d74_63152445 (Smarty_Internal_Template $_smarty_tpl) {
...
>
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="text" class="form-control">
                                        <select name="reu_lie" class="form-control" <?php echo $_smarty_tpl->tpl_vars['readonly']->value;?>
>
                                            <?php
...
" <?php echo $_smarty_tpl->tpl_vars['readonly']->value;?>
 required>
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="text" class="form-control">
                                        <select name="reu_acc" class="form-control" <?php echo $_smarty_tpl->tpl_vars['readonly']->value;?>
>
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="text" class="form-control">
                                        <input type="checkbox" name="reu_pub" class="form-control"
                                               value="1" <?php if ($_smarty_tpl->tpl_vars['unReunion']->value->getReuPub()) {?>checked<?php }?> <?php echo $_smarty_tpl->tpl_vars['readonly']->value;?>
>
                                    </label>
                                </div>
