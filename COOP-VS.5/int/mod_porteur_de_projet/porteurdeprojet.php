...
//Routeur pour le porteur de projet
class Porteurdeprojet
{
    ...
    public function __construct($parametre)
    {
        ...
        // Création d'un objet, instance de la classe PorteurdeprojetControleur
        $this->oControleur = new PorteurdeprojetControleur($this->parametre);
    }
