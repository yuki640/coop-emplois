                            ...
                            <div class="card-body card-block">
                                ...
                                {if $action neq 'ajouter'}
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="codel" class="form-control"
                                               value="{$unAccompagnateurs->getCodeL()}"
                                               readonly>
                                    </div>
                                {/if}
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="adresse1" class="form-control"
                                           value="{$unAccompagnateurs->getAdresse1()}" {$readonly}>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="adresse1=2" class="form-control"
                                           value="{$unAccompagnateurs->getAdresse2()}" {$readonly}>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="adresse3" class="form-control"
                                           value="{$unAccompagnateurs->getAdresse3()}" {$readonly}>
                                </div>

                                <div class="form-group">
                                    <label for="text" class=" form-control">
                                        Mention de distribution, accompagnateurs-dit :
                                    </label>
                                    <input type="text" name="adresse4" class="form-control"
                                           value="{$unAccompagnateurs->getAdresse4()}" {$readonly}>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="codepostal" class="form-control"
                                           value="{$unAccompagnateurs->getCodepostal()}"
                                            {$readonly}
                                            required
                                    >
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="ville" class="form-control"
                                           value="{$unAccompagnateurs->getVille()}"
                                            {$readonly}
                                            required
                                    >
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="telephoneS" class="form-control"
                                           value="{$unAccompagnateurs->getTelephoneS()}" {$readonly}>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="contact" class="form-control"
                                           value="{$unAccompagnateurs->getContact()}" {$readonly}>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="telephoneC" class="form-control"
                                           value="{$unAccompagnateurs->getTelephoneC()}" {$readonly}
                                           required
                                    >
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="capacite" class="form-control"
                                           value="{$unAccompagnateurs->getCapacite()}" {$readonly}
                                           required
                                    >
                                </div>
