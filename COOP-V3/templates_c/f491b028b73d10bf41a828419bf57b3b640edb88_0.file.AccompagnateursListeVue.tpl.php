...
function content_6500b01c600e85_80428500 (Smarty_Internal_Template $_smarty_tpl) {
?><!doctype html>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div <?php if (AccompagnateursTable::getMessageSucces() != '') {?> class="alert alert-success"
                                    role="alert" <?php }?>>
